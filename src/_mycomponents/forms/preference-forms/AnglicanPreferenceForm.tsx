...
export default function AnglicanPreferenceForm() {
  ...
  const [vocalSections, setVocalSections] = useState({
    startOfRosary: [
      { id: '1', name: 'Vocal Name 1', checked: false, duration: '0:30 sec', audioFile: 'audio1.mp3' },
      { id: '2', name: 'Vocal Name 1', checked: false, duration: '0:30 sec', audioFile: 'audio2.mp3' },
      { id: '3', name: 'Vocal Name 1', checked: false, duration: '0:30 sec', audioFile: 'audio3.mp3' },
      { id: '4', name: 'Vocal Name 1', checked: false, duration: '0:30 sec', audioFile: 'audio4.mp3' },
    ],
    Processional: [
  ...
  return (
    <div className="max-w-4xl mx-auto shadow-lg rounded-md p-4 bg-white dark:bg-gray-800">
      <h2 className="text-3xl font-bold mb-5 mt-5 text-gray-900 dark:text-white">Anglican Service Preferences</h2>
